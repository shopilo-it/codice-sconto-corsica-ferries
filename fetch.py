#!/usr/bin/env python3
"""
Recupero codici sconto Corsica Ferries da shopilo.it
Sursa: https://shopilo.it/negozi/corsica-ferries.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/corsica-ferries.it"
STORE_NAME = "Corsica Ferries"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Corsica Ferries da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-corsica-ferries)"
    }
    try:
